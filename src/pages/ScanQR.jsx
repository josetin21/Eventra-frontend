        ...
        api.get(`/attendance/sessions/events/${eventId}`)
            .then(res =>{
                ...
                if (session.length > 0){
                    ...
                    const isActive = new Date(latest.expiresAt) > new Date()
                    if (isActive) {
                        setSession(latest)
                    } else {
                        setSession(null)
                    ...
                    <div>
                        <div className='flex items-center justify-between mb-4'>
                            <div className='flex items-center gap-2'>
                                <span className='w-3 h-3 border-y-green-500 rounded-full animate-pulse inline-block'></span>
                        ...
                        {attendance.map((a, i ) =>(
                            <div key={i} className='flex items-center justify-between py-3'>
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div>
                                        <p className='text-sm font-medium text-gray-800'>{a.attendeeName}</p>
                                        <p className='text-xs text-gray-400'>{a.attendeeEmail}</p>
                                    </div>
                                </div>
